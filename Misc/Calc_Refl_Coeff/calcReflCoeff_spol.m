%%Nicole Bienert
%4-15-2021
%Calculate the reflection coeffecient for an s-polarized wave. We assume
...
function refParE=calcReflCoeff(er_ice,tan_ice,er_bed,tan_bed,thetaI)
...
refParE = (eta_bed.*cos(thetaI)-eta_ice.*cosThetaT)./(eta_bed.*cos(thetaI)+eta_ice.*cosThetaT); %E Parallel to Interface
